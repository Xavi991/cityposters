@if(isset($offersDescription[3]))
	...
	@elseif($offersDesign[3] === 4)<!--DISEÑO 4-->
	...
	@elseif($offersDesign[3] === 5)<!--DISEÑO 5-->

		<?php
			$cincuentaPorciento= $offersBefore[3] / 2;
			$precioFinal= $cincuentaPorciento + $offersBefore[3];
		?>
		...
		<span class="offer-description offer-price-2 offer-price-2-fifth-design">
			<span style="font-size: 15px;">1 UNIDAD:</span>
	 		<span class="guaranies">Gs</span>
	 		<span>{{number_format($offersBefore[3], 0, "", ".")}}</span>
	 	</span>
	 ...
	 @elseif($offersDesign[3] === 6)<!--DISEÑO 6-->

		<?php
			$SetentaPorciento= ($offersBefore[3] * 70) / 100;
			$precioFinal= $SetentaPorciento + $offersBefore[3];
		?>
